...
runCGSModels <- function(
  ...
  if (length(topic) > 1){
    ...
    if (nCores > 1){
      ...
      registerDoSNOW(cl)
      clusterEvalQ(cl, library(lgr, lib="/data/gent/vo/000/gvo00027/multimodal_omics_GRN/lib_cistopic"))
      clusterEvalQ(cl, library(lda, lib="/data/gent/vo/000/gvo00027/multimodal_omics_GRN/lib_cistopic"))
...
runWarpLDAModels <- function(
  ...
  if (length(topic) > 1){
    ...
    if (nCores > 1){
      ...
      registerDoSNOW(cl)
      clusterEvalQ(cl, library(lgr, lib="/data/gent/vo/000/gvo00027/multimodal_omics_GRN/lib_cistopic"))
      clusterEvalQ(cl, library(text2vec, lib = "/data/gent/vo/000/gvo00027/multimodal_omics_GRN/lib_cistopic"))
